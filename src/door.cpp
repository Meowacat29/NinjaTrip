...
bool Door::init()
{
	...
	float wr = door_texture.width * SIZE_MODIFIER;
	float hr = door_texture.height *SIZE_MODIFIER;
...
// Returns the local bounding coordinates scaled by the current size of the door
